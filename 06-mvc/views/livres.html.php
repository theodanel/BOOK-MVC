            ...
            <div class="w-1/2 lg:w-1/4 mb-6">
                <div class="shadow-lg rounded-lg h-full mx-3">
                    <div class="flex flex-col justify-between h-full">
                        <a href="livre.html.php?id=<?= $book['id']; ?>">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-xs text-center text-gray-400">
                                    Par <strong><?= $book['author']; ?></strong> en <?= ($book['publishedAt']); ?>
                                </p>
                                <p class="text-xs text-center text-gray-400">
                        ...
                        <div class="text-center">
                            ...
                            <a class="bg-red-700 px-4 py-2 text-white inline-block rounded hover:bg-red-500 duration-200 mb-4" href="livres/delete/<?=$book['id']; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
